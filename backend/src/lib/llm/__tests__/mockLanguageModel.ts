...
import type { LanguageModelV3StreamPart } from "@ai-sdk/provider" with {
  "resolution-mode": "import",
};
...
export type Part = LanguageModelV3StreamPart;
...
export async function makeModel(steps: Array<ReturnType<typeof step> | Error>) {
...
/**
 * Mirror of the module-private pause class in the chat engine. The ask_inputs
